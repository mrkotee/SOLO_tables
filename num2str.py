...
units = (
    ...
    u'трех', u'четырех', u'пяти',
    u'шести', u'семи', u'восьми', u'девяти'
)

teens = (
    u'десяти', u'одиннадцати',
    u'двенадцати', u'тринадцати',
    u'четырнадцати', u'пятнадцати',
    u'шестнадцати', u'семнадцати',
    u'восемнадцати', u'девятнадцати'
)

tens = (
    teens,
    u'двадцати', u'тридцати',
    u'сорока', u'пятидесяти',
    u'шестидесяти', u'семидесяти',
    u'восьмидесяти', u'девяноста'
)

hundreds = (
    u'ста', u'двухсот',
    u'трёхсот', u'четырёхсот',
